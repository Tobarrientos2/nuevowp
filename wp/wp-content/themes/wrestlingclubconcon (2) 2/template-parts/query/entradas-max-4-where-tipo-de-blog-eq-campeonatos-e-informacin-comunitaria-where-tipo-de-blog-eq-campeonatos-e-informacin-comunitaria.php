...
$args = [
  ...
  "meta_query" => [
    ...
    [
      "key" => "tipo-de-blog",
      "value" => "Campeonatos e Información Comunitaria",
      "compare" => "=="
    ],
    [
      "key" => "tipo-de-blog",
...
$args = apply_filters('udesly/posts/entradas-max-4-where-tipo-de-blog-eq-campeonatos-e-informacin-comunitaria-where-tipo-de-blog-eq-campeonatos-e-informacin-comunitaria', $args);
        
        $query = new WP_Query($args);
?>
<div id="w-node-f31fc33b-bbe0-ae46-877a-fa0f1b4731e1-9456fb76" class="sliders in w-dyn-list" udy-collection="entradas">
        <?php if ( $query->have_posts() ) : ?><div id="w-node-f31fc33b-bbe0-ae46-877a-fa0f1b4731e2-9456fb76" role="list" class="slide slick-wrapper w-dyn-items">
            ...
            <a href="<?php the_permalink() ?>" class="container-card w-inline-block">
              ...
              <div class="container-info is-margin-t-16">
                ...
                <div class="container-info horizontal no-wrap no-gap">
                  ...
                  <div class="is-h5 is-txt-white-100 mukta no-gap"><?php echo udesly_get_custom_post_field( $post->ID, "tiempo-de-lectura", "Number" ) ?></div>
