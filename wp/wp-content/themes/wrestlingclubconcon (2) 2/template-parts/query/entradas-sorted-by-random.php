...
$args = apply_filters('udesly/posts/entradas-sorted-by-random', $args);
        
        $query = new WP_Query($args);
?>
<div id="w-node-af916a9a-311c-0932-1f25-fc5751fd017e-8673157f" class="sliders in entrada w-dyn-list" udy-collection="entradas">
        <?php if ( $query->have_posts() ) : ?><div id="w-node-af916a9a-311c-0932-1f25-fc5751fd017f-8673157f" role="list" class="slide slick-wrapper w-dyn-items">
          <?php while ($query->have_posts()) : $query->the_post(); global $post; ?><div id="w-node-af916a9a-311c-0932-1f25-fc5751fd0180-8673157f" role="listitem" class="card blog three w-dyn-item">
