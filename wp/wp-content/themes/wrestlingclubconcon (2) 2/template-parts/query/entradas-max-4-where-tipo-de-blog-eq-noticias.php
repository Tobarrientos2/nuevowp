...
$args = apply_filters('udesly/posts/entradas-max-4-where-tipo-de-blog-eq-noticias', $args);
        
        $query = new WP_Query($args);
?>
<div id="w-node-dda30c14-e58f-7af6-e7d1-15ca893f2c8b-9456fb76" class="sliders in w-dyn-list" udy-collection="entradas">
        <?php if ( $query->have_posts() ) : ?><div id="w-node-dda30c14-e58f-7af6-e7d1-15ca893f2c8c-9456fb76" role="list" class="slide slick-wrapper w-dyn-items">
          <?php while ($query->have_posts()) : $query->the_post(); global $post; ?><div id="w-node-dda30c14-e58f-7af6-e7d1-15ca893f2c8d-9456fb76" role="listitem" class="card blog three w-dyn-item">
