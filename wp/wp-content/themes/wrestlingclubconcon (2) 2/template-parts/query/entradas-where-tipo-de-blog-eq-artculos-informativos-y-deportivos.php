...
$args = [
  ...
  "meta_query" => [
    ...
    [
      "key" => "tipo-de-blog",
      "value" => "Artículos Informativos y Deportivos",
      "compare" => "=="
    ]
  ],
  "paged" => $paged
...
$args = apply_filters('udesly/posts/entradas-where-tipo-de-blog-eq-artculos-informativos-y-deportivos', $args);
        
        $query = new WP_Query($args);
?>
<div id="w-node-_249bb5de-7b56-fdb5-68a6-d231f3623dc2-9456fb76" class="sliders in w-dyn-list" udy-collection="entradas">
        <?php if ( $query->have_posts() ) : ?><div id="w-node-_249bb5de-7b56-fdb5-68a6-d231f3623dc3-9456fb76" role="list" class="slide slick-wrapper w-dyn-items">
