...
var apiUrl = 'https://x0pw-sykj-esxe.b2.xano.io/api:Bmubv5VR/user_create_tbk';
...
// Verificar la estructura de la respuesta y asignar los valores correctamente
var url = response.data.url || '';
var token = response.data.token || '';
// Crear el formulario con los parámetros
var formHTML = '<form method="post" action="' + url + '">';
formHTML += '<input type="hidden" name="token_ws" value="' + token + '" />';
formHTML += '<input type="submit" value="Ir a pagar" class="btn-prm--med" />';
formHTML += '</form>';
// Agregar el formulario al elemento con el ID "Section-Forms"
$('#Section-Forms').html(formHTML);
},
